...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Editar Aprendiz</h1>
        <form action="../Controllers/Aprendizcontrolador.php" method="POST" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="numero_doc" id="numero_doc" class="form-control" required autocomplete="new-password">
            </div>
            <div class="mb-3">
                <label for="tipo_documento" class="form-label"><i class="fas fa-file-alt"></i> Tipo de Documento:</label>
                <select name="id_tipo_doc" id="tipo_documento" class="form-select" required autocomplete="new-password">
            ...
            <div class="mb-3">
                ...
                <select name="id_genero" id="genero" class="form-select" required autocomplete="new-password">
                    <option value="">Selecciona una opción</option>
            ...
            <div class="mb-3">
                ...
                <select name="id_grupo_sanguineo" id="grupo_sanguineo" class="form-select" required autocomplete="new-password">
                    <option value="">Selecciona una opción</option>
            ...
            <div class="mb-3">
                ...
                <select name="id_programa_formacion" id="programa_formacion" class="form-select" required autocomplete="new-password">
                    <option value="">Selecciona una opción</option>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" required autocomplete="new-password">
            </div>
            <button type="submit" name="editar" class="btn btn-warning mt-3 w-100">
