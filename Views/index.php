...
<body>
    <div class="container mt-5">
        ...
        <a class="btn btn-success mb-3" href="../Views/create.php"><i class="fas fa-plus"></i> Crear aprendiz</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($aprendices as $index => $aprendiz) : ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($aprendiz['programa_formacion']) ?></td>
                            <td>
                            ...
                            <td>
                                <form action="../Controllers/Aprendizcontrolador.php" method="POST">
                            ...
                            <td>
                                <a href="./view.php?id=<?= $aprendiz['id'] ?>" class="btn btn-info btn-sm">
